...
public class SaudiaArabiaTeam implements NationalTeamStats {
    ...
    public static long getNmbTimesAsked() {
        return nmbTimesAsked;
    }

    public static void addNmbTimesAsked() {
        SaudiaArabiaTeam.nmbTimesAsked++;
    }

    private static long nmbTimesAsked = 0;
    ...
    public void CreateJsonFile()
    {
        try {
            ...
            FileWriter file = new FileWriter("C:/project/banco2.json");
